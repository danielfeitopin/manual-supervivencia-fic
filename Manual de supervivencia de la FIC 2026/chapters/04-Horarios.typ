...
Los horarios de los grados (#link("https://www.fic.udc.es/gl/horarios-e-exames")[@GEI],
#link("https://www.fic.udc.es/gl/horarios-e-exames-gced")[@GCED] y
#link("https://www.fic.udc.es/gl/horarios-y-examenes-0")[@GIA]) pueden encontrarse en sus correspondientes apartados de la página web de la
#link("https://www.fic.udc.es")[FIC].
Los másteres suelen publicar sus horarios en sus respectivas páginas web.

#curiosityBox[
  Los horarios de un curso son aprobados a finales del curso académico anterior, por lo que pueden ser consultados antes del comienzo de las clases e incluso antes de la propia matrícula.
]

== Nomenclatura de los horarios
...
=== Selección de preferencia del horario

La preferencia de franja horaria (mañana o tarde) puede indicarse en
#link("https://espazos.udc.es/")[Espazos UDC].
Primero debe seleccionarse el centro (Facultade de Informática) y luego acceder a la sección del menú
#link("https://espazos.udc.es/centers/614/timetable/preference")[_As miñas opcións/preferencia de horario de docencia_].
...
#importantBox[
En el caso de que no se pueda encontrar una solución, es posible que algunas de las asignaturas *se solapen*. Para solventar esto, podrá solicitarse un *cambio de grupo*.
]
...
#importantBox[
  ...
  #link("mailto:vicedecanato.infraestruturas.fic@udc.gal")[*vicedecanato.infraestruturas.fic\@udc.gal*]
